...
[`@aws-sdk/client-customer-profiles`](https://www.npmjs.com/package/@aws-sdk/client-customer-profiles/v/3.549.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-customer-profiles@3.549.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZnTbbepTWUJQ5IhrDFJmYmnxs77RYxIfhpr6gTrBBcTabrvPUPfeXfHK8vwk9/kB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-customer-profiles": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-customer-profiles@3.549.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-customer-profiles@3.549.0/index.min.mjs": "sha384-ZnTbbepTWUJQ5IhrDFJmYmnxs77RYxIfhpr6gTrBBcTabrvPUPfeXfHK8vwk9/kB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-customer-profiles/blob/refs/tags/3.549.0/LICENSE
```
